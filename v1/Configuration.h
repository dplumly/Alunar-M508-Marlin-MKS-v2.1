...
#define STRING_CONFIG_H_AUTHOR "(dplumly, Infitary/Alunar M508)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "M508"
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way. search me
...
// For direct drive extruder v9 set to true, for geared extruder set to false. search me
#define INVERT_E0_DIR false // I changed
